package hotel.example.hotelreservaion.config;
...
import hotel.example.hotelreservaion.service.*;
import hotel.example.hotelreservaion.util.*;
@Configuration
@EnableWebSecurity
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .requestMatchers("/auth/login", "/service", "/auth/signup","/test").permitAll()
